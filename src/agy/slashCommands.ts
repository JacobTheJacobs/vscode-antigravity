...
export const SLASH_COMMANDS: SlashCommand[] = [
    ...
    // /effort and /sandbox are intentionally NOT here: both live on the
    // Execution menu (the effort chip), with Tool access alongside them. A
    // second route in the command list was a duplicate, so it is gone.
